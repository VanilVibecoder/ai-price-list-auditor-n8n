...
![Результат обработки в Telegram](docs/telegram-result.png)
...
2. Импортируйте `workflow/ai-price-list-auditor.json`.
3. Создайте Telegram credential.
4. Создайте Ollama credential.
5. Назначьте credentials соответствующим нодам.
6. Проверьте URL Ollama из контейнера n8n.
7. Активируйте workflow.
8. Отправьте тестовый CSV с разделителем `;` или XLSX.
